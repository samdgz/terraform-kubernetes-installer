...
module "instances-etcd-ad1" {
  ...
  control_plane_subnet_access = "${var.control_plane_subnet_access}"
  display_name_prefix         = "${(var.region == "us-ashburn-1") ? "ociash1-${var.regulatory_domain}-patronus-etcd-01" : "ociphx1-${var.regulatory_domain}-patronus-etcd-01"}"
  domain_name                 = "${var.domain_name}"
  ...
  hostname_label_prefix       = "${(var.region == "us-ashburn-1") ? "ociash1-${var.regulatory_domain}-patronus-etcd-01" : "ociphx1-${var.regulatory_domain}-patronus-etcd-01"}"
...
module "instances-etcd-ad2" {
  ...
  compartment_ocid            = "${(var.multiple_compartments == "true")  ? var.coreservice_compartment_ocid : var.compartment_ocid}"
  control_plane_subnet_access = "${var.control_plane_subnet_access}"
  display_name_prefix         = "${(var.region == "us-ashburn-1") ? "ociash1-${var.regulatory_domain}-patronus-etcd-02" : "ociphx1-${var.regulatory_domain}-patronus-etcd-02"}"
  domain_name                 = "${var.domain_name}"
  etcd_discovery_url          = "${template_file.etcd_discovery_url.id}"
  flannel_backend             = "${var.flannel_backend}"
  flannel_network_cidr        = "10.99.0.0/16"
  flannel_network_subnetlen   = 24
  hostname_label_prefix       = "${(var.region == "us-ashburn-1") ? "ociash1-${var.regulatory_domain}-patronus-etcd-02" : "ociphx1-${var.regulatory_domain}-patronus-etcd-02"}"
  oracle_linux_image_name     = "${var.etcd_ol_image_name}"
  label_prefix                = "${var.label_prefix}"
  shape                       = "${var.etcdShape}"
  ssh_public_key_openssh      = "${module.k8s-tls.ssh_public_key_openssh}"
...
module "instances-etcd-ad3" {
  ...
  compartment_ocid            = "${(var.multiple_compartments == "true")  ? var.coreservice_compartment_ocid : var.compartment_ocid}"
  control_plane_subnet_access = "${var.control_plane_subnet_access}"
  display_name_prefix         = "${(var.region == "us-ashburn-1") ? "ociash1-${var.regulatory_domain}-patronus-etcd-03" : "ociphx1-${var.regulatory_domain}-patronus-etcd-03"}"
  docker_ver                  = "${var.docker_ver}"
  domain_name                 = "${var.domain_name}"
  etcd_discovery_url          = "${template_file.etcd_discovery_url.id}"
  ...
  flannel_network_cidr        = "10.99.0.0/16"
  flannel_network_subnetlen   = 24
  hostname_label_prefix       = "${(var.region == "us-ashburn-1") ? "ociash1-${var.regulatory_domain}-patronus-etcd-03" : "ociphx1-${var.regulatory_domain}-patronus-etcd-03"}"
  oracle_linux_image_name     = "${var.etcd_ol_image_name}"
  label_prefix                = "${var.label_prefix}"
  shape                       = "${var.etcdShape}"
  ssh_public_key_openssh      = "${module.k8s-tls.ssh_public_key_openssh}"
...
module "instances-k8smaster-ad1" {
  ...
  compartment_ocid            = "${(var.multiple_compartments == "true")  ? var.coreservice_compartment_ocid : var.compartment_ocid}"
  control_plane_subnet_access = "${var.control_plane_subnet_access}"
  display_name_prefix         = "${(var.region == "us-ashburn-1") ? "ociash1-${var.regulatory_domain}-patronus-k8smaster-01" : "ociphx1-${var.regulatory_domain}-patronus-k8smaster-01"}"
  docker_ver                  = "${var.docker_ver}"
  ...
  etcd_ver                    = "${var.etcd_ver}"
  flannel_ver                 = "${var.flannel_ver}"
  hostname_label_prefix       = "${(var.region == "us-ashburn-1") ? "ociash1-${var.regulatory_domain}-patronus-k8smaster-01" : "ociphx1-${var.regulatory_domain}-patronus-k8smaster-01"}"
...
module "instances-k8smaster-ad2" {
  ...
  compartment_ocid            = "${(var.multiple_compartments == "true")  ? var.coreservice_compartment_ocid : var.compartment_ocid}"
  control_plane_subnet_access = "${var.control_plane_subnet_access}"
  display_name_prefix         = "${(var.region == "us-ashburn-1") ? "ociash1-${var.regulatory_domain}-patronus-k8smaster-02" : "ociphx1-${var.regulatory_domain}-patronus-k8smaster-02"}"
  docker_ver                  = "${var.docker_ver}"
  master_docker_max_log_size  = "${var.master_docker_max_log_size}"
  master_docker_max_log_files = "${var.master_docker_max_log_files}"
  domain_name                 = "${var.domain_name}"
  ...
  etcd_ver                    = "${var.etcd_ver}"
  flannel_ver                 = "${var.flannel_ver}"
  hostname_label_prefix       = "${(var.region == "us-ashburn-1") ? "ociash1-${var.regulatory_domain}-patronus-k8smaster-02" : "ociphx1-${var.regulatory_domain}-patronus-k8smaster-02"}"
  oracle_linux_image_name     = "${var.master_ol_image_name}"
  k8s_dashboard_ver           = "${var.k8s_dashboard_ver}"
  k8s_dns_ver                 = "${var.k8s_dns_ver}"
  k8s_ver                     = "${var.k8s_ver}"
...
module "instances-k8smaster-ad3" {
  ...
  compartment_ocid            = "${(var.multiple_compartments == "true")  ? var.coreservice_compartment_ocid : var.compartment_ocid}"
  control_plane_subnet_access = "${var.control_plane_subnet_access}"
  display_name_prefix         = "${(var.region == "us-ashburn-1") ? "ociash1-${var.regulatory_domain}-patronus-k8smaster-03" : "ociphx1-${var.regulatory_domain}-patronus-k8smaster-03"}"
  docker_ver                  = "${var.docker_ver}"
  master_docker_max_log_size  = "${var.master_docker_max_log_size}"
  master_docker_max_log_files = "${var.master_docker_max_log_files}"
  domain_name                 = "${var.domain_name}"
  ...
  etcd_ver                    = "${var.etcd_ver}"
  flannel_ver                 = "${var.flannel_ver}"
  hostname_label_prefix       = "${(var.region == "us-ashburn-1") ? "ociash1-${var.regulatory_domain}-patronus-k8smaster-03" : "ociphx1-${var.regulatory_domain}-patronus-k8smaster-03"}"
  oracle_linux_image_name     = "${var.master_ol_image_name}"
  k8s_dashboard_ver           = "${var.k8s_dashboard_ver}"
  k8s_dns_ver                 = "${var.k8s_dns_ver}"
  k8s_ver                     = "${var.k8s_ver}"
...
module "instances-k8sworker-ad1" {
  ...
  availability_domain         = "${lookup(data.oci_identity_availability_domains.ADs.availability_domains[0],"name")}"
  compartment_ocid            = "${(var.multiple_compartments == "true")  ? var.coreservice_compartment_ocid : var.compartment_ocid}"
  display_name_prefix         = "${(var.region == "us-ashburn-1") ? "ociash1-${var.regulatory_domain}-patronus-k8sworker-01" : "ociphx1-${var.regulatory_domain}-patronus-k8sworker-01"}"
  docker_ver                  = "${var.docker_ver}"
  ...
  etcd_ver                    = "${var.etcd_ver}"
  flannel_ver                 = "${var.flannel_ver}"
  hostname_label_prefix       = "${(var.region == "us-ashburn-1") ? "ociash1-${var.regulatory_domain}-patronus-k8sworker-01" : "ociphx1-${var.regulatory_domain}-patronus-k8sworker-01"}"
...
module "instances-k8sworker-ad2" {
  ...
  availability_domain         = "${lookup(data.oci_identity_availability_domains.ADs.availability_domains[1],"name")}"
  compartment_ocid            = "${(var.multiple_compartments == "true")  ? var.coreservice_compartment_ocid : var.compartment_ocid}"
  display_name_prefix         = "${(var.region == "us-ashburn-1") ? "ociash1-${var.regulatory_domain}-patronus-k8sworker-02" : "ociphx1-${var.regulatory_domain}-patronus-k8sworker-02"}"
  docker_ver                  = "${var.docker_ver}"
  worker_docker_max_log_size  = "${var.worker_docker_max_log_size}"
  worker_docker_max_log_files = "${var.worker_docker_max_log_files}"
  domain_name                 = "${var.domain_name}"
  ...
  etcd_ver                    = "${var.etcd_ver}"
  flannel_ver                 = "${var.flannel_ver}"
  hostname_label_prefix       = "${(var.region == "us-ashburn-1") ? "ociash1-${var.regulatory_domain}-patronus-k8sworker-02" : "ociphx1-${var.regulatory_domain}-patronus-k8sworker-02"}"
  oracle_linux_image_name     = "${var.worker_ol_image_name}"
  k8s_ver                     = "${var.k8s_ver}"
  label_prefix                = "${var.label_prefix}"
  master_lb                   = "${local.master_lb_address}"
...
module "instances-k8sworker-ad3" {
  ...
  availability_domain         = "${lookup(data.oci_identity_availability_domains.ADs.availability_domains[2],"name")}"
  compartment_ocid            = "${(var.multiple_compartments == "true")  ? var.coreservice_compartment_ocid : var.compartment_ocid}"
  display_name_prefix         = "${(var.region == "us-ashburn-1") ? "ociash1-${var.regulatory_domain}-patronus-k8sworker-03" : "ociphx1-${var.regulatory_domain}-patronus-k8sworker-03"}"
  docker_ver                  = "${var.docker_ver}"
  worker_docker_max_log_size  = "${var.worker_docker_max_log_size}"
  worker_docker_max_log_files = "${var.worker_docker_max_log_files}"
  domain_name                 = "${var.domain_name}"
  ...
  etcd_ver                    = "${var.etcd_ver}"
  flannel_ver                 = "${var.flannel_ver}"
  hostname_label_prefix       = "${(var.region == "us-ashburn-1") ? "ociash1-${var.regulatory_domain}-patronus-k8sworker-03" : "ociphx1-${var.regulatory_domain}-patronus-k8sworker-03"}"
  oracle_linux_image_name     = "${var.worker_ol_image_name}"
  k8s_ver                     = "${var.k8s_ver}"
  label_prefix                = "${var.label_prefix}"
  master_lb                   = "${local.master_lb_address}"
