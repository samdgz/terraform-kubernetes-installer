...
module "oci-cloud-controller" {
  ...
  cloud_controller_user_private_key_password = "${var.cloud_controller_user_private_key_password == "" ? var.private_key_password : var.cloud_controller_user_private_key_password}"
