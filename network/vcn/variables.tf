variable "network_cidrs" {
  ...
  default = {
    ...
    serviceProxySubnetAD1  = "10.1.70.0/24"
    serviceProxySubnetAD2  = "10.1.71.0/24"
    serviceProxySubnetAD3  = "10.1.72.0/24"
    ...
    managementSubnetAD1  = "10.1.60.0/24"
    managementSubnetAD2  = "10.1.61.0/24"
    managementSubnetAD3  = "10.1.62.0/24"
  }
}
