...
resource "oci_core_instance" "BastionInstanceAD1" {
  ...
  display_name        = "${(var.region == "us-ashburn-1") ? "ociash1-${var.regulatory_domain}-patronus-bastion-01" : "ociphx1-${var.regulatory_domain}-patronus-bastion-01"}"
  image               = "${lookup(data.oci_core_images.BastionImageOCID.images[0], "id")}"
  shape               = "${var.bastion_instance_shape}"
  hostname_label      = "${(var.region == "us-ashburn-1") ? "ociash1-${var.regulatory_domain}-patronus-bastion-01" : "ociphx1-${var.regulatory_domain}-patronus-bastion-01"}"
...
resource "oci_core_instance" "BastionInstanceAD2" {
  ...
  compartment_id      = "${(var.multiple_compartments == "true")  ? var.bastion_compartment_ocid : var.compartment_ocid}"
  display_name        = "${(var.region == "us-ashburn-1") ? "ociash1-${var.regulatory_domain}-patronus-bastion-02" : "ociphx1-${var.regulatory_domain}-patronus-bastion-02"}"
  image               = "${lookup(data.oci_core_images.BastionImageOCID.images[0], "id")}"
  shape               = "${var.bastion_instance_shape}"
  hostname_label      = "${(var.region == "us-ashburn-1") ? "ociash1-${var.regulatory_domain}-patronus-bastion-02" : "ociphx1-${var.regulatory_domain}-patronus-bastion-02"}"
...
resource "oci_core_instance" "BastionInstanceAD3" {
  ...
  compartment_id      = "${(var.multiple_compartments == "true")  ? var.bastion_compartment_ocid : var.compartment_ocid}"
  display_name        = "${(var.region == "us-ashburn-1") ? "ociash1-${var.regulatory_domain}-patronus-bastion-03" : "ociphx1-${var.regulatory_domain}-patronus-bastion-03"}"
  image               = "${lookup(data.oci_core_images.BastionImageOCID.images[0], "id")}"
  shape               = "${var.bastion_instance_shape}"
  hostname_label      = "${(var.region == "us-ashburn-1") ? "ociash1-${var.regulatory_domain}-patronus-bastion-03" : "ociphx1-${var.regulatory_domain}-patronus-bastion-03"}"
